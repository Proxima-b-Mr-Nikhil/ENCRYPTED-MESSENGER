    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG, txt_password);
                System.out.println(txt_password);

                SharedPreferences.Editor localEditor = getSharedPreferences("credentials", Context.MODE_PRIVATE ).edit();
                localEditor.putString("username", txt_email);
                localEditor.putString("password", txt_password);
