...
import com.proxima_b.encryptedmessenger.Adapter.MessageAdapter;
import com.proxima_b.encryptedmessenger.Fragments.APIService;
import com.proxima_b.encryptedmessenger.Model.Chat;
import com.proxima_b.encryptedmessenger.Model.User;
import com.proxima_b.encryptedmessenger.Notifications.Client;
import com.proxima_b.encryptedmessenger.Notifications.Data;
...
import com.proxima_b.encryptedmessenger.Notifications.Token;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.drawable.defaultpic, username+": "+message, "New Message",
                            userid);
